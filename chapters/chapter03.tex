...
\caption{{\color{red}\textit{Changes in word error rate (\%WER) and phone error rate (\%PER) following variation of the number of total Gaussians allocated to the acoustic model. Scores correspond to decoding performed on the validation set. [TODO]: Add WER + Korean data. Add triphone performance for comparison.}}}
...
\item Lexicon-based decoding
  \begin{itemize}
  \item CSJ mono-pitchT-6000: WER; PER 
  \item KCSS mono-pitchT-6000: WER; PER
  \end{itemize}
