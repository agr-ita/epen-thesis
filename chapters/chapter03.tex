...
\begin{figure}[htb!]
    \centering
    \includegraphics[page=7, width=1\linewidth]{chapter03/art2ac_model_pgrams.pdf}
...
%# WPDT
%forecast::CV(lm(prop_vowel.human ~ prop_vowel.mfcc*Position*Vowel, data=d.ewan[d.ewan$wpd==T,]))["CV"]
%# CV = 0.01572393

%# WPDF
%forecast::CV(lm(prop_vowel.human ~ prop_vowel.mfcc*Position*Vowel, data=d.ewan[d.ewan$wpd==F,]))["CV"]
%# CV = 0.01352878
...
\begin{figure}[htb!]
  \centering
    \includegraphics[page=3, width=0.7\linewidth]{chapter03/art2ac_model_pgrams.pdf} \\
    \vspace{0.5cm}
    \includegraphics[page=4, width=0.7\linewidth]{chapter03/art2ac_model_pgrams.pdf}
    \caption{{\color{red}[TODO]%\textit{Response patterns for the identification task. Human and models responses are separated by columns; responses are given by rows. Within each rectangle, the horizontal axis separates proportions according to $C_{1}$. The vertical axis corresponds to proportion of responses (i.e., posteriorgrams, in the case of models). The box and whiskers plots display the distribution of the proportions across items (median, quartiles and extrema).}
        }}
    \label{fig:wpd-hum}
  \end{figure}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[page=5, width=0.7\linewidth]{chapter03/art2ac_model_pgrams.pdf}\\
    \vspace{0.5cm}
    \includegraphics[page=6, width=0.65\linewidth]{chapter03/art2ac_model_pgrams.pdf}
