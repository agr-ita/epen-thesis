...
\begin{figure}[htb!]
  ...
  \caption{\textit{Identification patterns on items with consonantal clusters. Proportion of ``none'', ``i'', and ``u''/``\textipa{1}'' responses given by the American English (left) and Korean (right) ASR systems. The box and whiskers plots display the distribution of the proportions across items (median, quartiles, extrema and outliers).}}
...
%Cross-linguistic effect or due to corpora???
