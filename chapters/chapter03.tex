...
% Summary %
%%%%%%%%%%%
In this chapter we used parametric models from the field of automatic speech recognition (ASR) as models of (nonnative) speech perception. We selected these models as they are defined within a Bayesian framework, as is the one-step reverse inference proposal by \cite{wilson2013}.
